...
const signUpUser = async (req, res) => {
    if (req.body.first_name && req.body.last_name && req.body.email && req.body.phone_number && req.body.password && req.body.address && req.body.state && req.body.postal_code) {
        try {
            ...
            const hashedPassword = await (0, userFunctions_1.hashUserPassword)(password);
            const userDetails = { first_name, last_name, email, phone_number, hashedPassword, address, state, postal_code };
